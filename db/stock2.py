...
ma20 = new_gs['endPrice'].rolling(window=20).mean()
ma60 = new_gs['endPrice'].rolling(window=60).mean()
ma120 = new_gs['endPrice'].rolling(window=120).mean()
...
# Plot
plt.plot(new_gs.index, new_gs['endPrice'], label='endPrice')
