...
mk = dbconn.MarketDB()
df_stock = mk.get_daily_stock_price('NDX', start_date, end_date, 'I')
df_apt = mk.get_daily_apt_price(loc1 = '서울특별시', loc2 = '송파구', loc3 = '잠실동', name = '리센츠', type='매매', startSize=80, endSize=85, start_date=start_date, end_date=end_date)
